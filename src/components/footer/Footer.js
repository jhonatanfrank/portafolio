    ...
    <div class="fondo">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 texto"><h1>Llena este formulario: </h1>
          <hr></hr>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="correoelectronico" placeholder="Ingrese su correo electronico" />
            </div>
            <div class="mb-3">
